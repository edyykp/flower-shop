...
export const AranjamenteCristelnita = props => {
    ...
    return (
      <Layout style={{width: "100%", maxWidth: "100%", backgroundColor: "white", paddingLeft: "100px", paddingRight:"100px", paddingBottom: "50px", marginBottom: "0px", height: "100%", maxHeight: "100%", paddingTop:"40px"}}>
          <Row >
                ...
                <Container style={{marginTop: "50px", marginLeft: "40px", width: "100%", maxWidth:"100%"}}>
                    <Row>
                          <Col style={{justifyContent: "left"}}>
                              <strong><h2>Aranjamente pentru cristelniță</h2></strong>
                          </Col>
