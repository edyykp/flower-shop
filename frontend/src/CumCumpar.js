    ...
    return (
        ...
        <Row style={{marginBottom: "40px"}}>
            ...
            <p style={{fontSize: "20px", color: "grey"}}>
                ...
                :
                <Layout style={{width: "100%", maxWidth: "100%",paddingTop:"40px", backgroundColor: "white", paddingLeft: "20px", paddingRight:"20px", paddingBottom: "50px", marginBottom: "0px", height: "100%", maxHeight: "100%"}}>
        <Row style={{marginBottom: "40px"}}>
            <Col style={{marginTop: "30px"}}>
            <h1 style={{paddingBottom: "10px"}}>Cum cumpăr?</h1>
            <p style={{fontSize: "20px", color: "grey"}}>
