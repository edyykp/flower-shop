...
export const BucheteFlori = props => {
    ...
    const [maxPrice, setMaxPrice] = useState(9999);
      ...
      const sortHandler = (x) => {
        let currentUrlParams = new URLSearchParams(window.location.search);
        currentUrlParams.set('sortOrder', x);
        props.history.push(window.location.pathname + "?" + currentUrlParams.toString());
      };
    return (
              ...
              <Col lg={9}>
                ...
                <Row>
                          <Col style={{justifyContent: "left"}}>
                              <strong><h2>Buchete de flori</h2></strong>
                          </Col>
                          <Col style={{justifyContent: "right"}}>
                              <Form inline>
                                  ...
                                  <Form.Control as="select" style={{marginLeft: "5px"}} onChange={(e) => {sortHandler(e.target.value);}} >
